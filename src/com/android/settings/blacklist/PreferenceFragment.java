...
public class PreferenceFragment extends SettingsPreferenceFragment implements
    ...
    private static final String BUTTON_BLACKLIST_NOTIFY = "phone_blacklist_notify_enabled";
    ...
    private static final String BUTTON_BLACKLIST_REGEX = "phone_blacklist_regex_enabled";

    private CheckBoxPreference mBlacklistNotify;
    private MultiSelectListPreference mBlacklistPrivate;
    private MultiSelectListPreference mBlacklistUnknown;
    private CheckBoxPreference mBlacklistRegex;
    ...
    public void onCreate(Bundle icicle) {
        ...
        mBlacklistNotify =
                (CheckBoxPreference) prefSet.findPreference(BUTTON_BLACKLIST_NOTIFY);
        mBlacklistNotify.setChecked(Settings.System.getBoolean(getContentResolver(),
                Settings.System.PHONE_BLACKLIST_NOTIFY_ENABLED, false));
        mBlacklistNotify.setOnPreferenceChangeListener(this);
        mBlacklistPrivate =
        ...
        mBlacklistRegex =
                (CheckBoxPreference) prefSet.findPreference(BUTTON_BLACKLIST_REGEX);
        mBlacklistRegex.setChecked(Settings.System.getBoolean(getContentResolver(),
                Settings.System.PHONE_BLACKLIST_REGEX_ENABLED, false));
        mBlacklistRegex.setOnPreferenceChangeListener(this);
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        if (preference == mBlacklistNotify) {
            Settings.System.putBoolean(getContentResolver(),
                    Settings.System.PHONE_BLACKLIST_NOTIFY_ENABLED, (Boolean) objValue);
            ...
            updateSelectListSummary(mBlacklistPrivate, newValues,
                    R.string.blacklist_private_numbers_summary,
                    R.string.blacklist_private_numbers_summary_disabled);
        } else if (preference == mBlacklistRegex) {
            Settings.System.putBoolean(getContentResolver(),
                    Settings.System.PHONE_BLACKLIST_REGEX_ENABLED, (Boolean) objValue);
        }
