...
public class HoverNotificationsEnabler implements CompoundButton.OnCheckedChangeListener {
   ...
   public HoverNotificationsEnabler(Context context, Switch switch_) {
        mContext = context;
        mSwitch = switch_;
    }
