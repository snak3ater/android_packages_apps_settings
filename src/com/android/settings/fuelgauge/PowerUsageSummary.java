...
public class PowerUsageSummary extends PreferenceFragment {
    ...
    private static final int SUBMENU_BATTERY_PERCENT        = Menu.FIRST + 13;
    private static final int SUBMENU_BATTERY_HIDDEN         = Menu.FIRST + 14;
    private static final int MENU_HELP                      = Menu.FIRST + 15;
	...
	batteryStyle.add(1, SUBMENU_BATTERY_PERCENT, 5, R.string.battery_percent_only)
                    .setChecked(selectedIcon == 4);
        batteryStyle.add(1, SUBMENU_BATTERY_HIDDEN, 6, R.string.battery_hidden)
